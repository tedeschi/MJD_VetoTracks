...
Phi is adjusted for each quadrant(due to taking the arctan) and the graphs are filled. The cosine of theta is taken and filled to a plot as well. An X and Y projection are taken of thetaPhiHist and slantHist and is added to a canvas. Each graph is edited, drawn, printed, and written to a root file. \\
\textbf{Calculations:} \\

$$surfDist=\sqrt{(xAtI)^{2}+(yAtI)^{2}}$$
$$r=\sqrt{(xAtI)^{2}+(yAtI)^{2}+(heightAtI-(heightAt0-1478))^{2}}$$
$$\theta=\sin^{-1}{(\frac{surfDist}{r})}$$
$$\phi=\tan^{-1}{(\frac{yAtI}{xAtI})}$$

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{surfCalc2.pdf}}%
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{slantDepthTop.png}}%
\end{figure}

\textbf{\emph{Calculated Slant depth for topology}:} \\
This plot describes the slant depth in an area around the Majorana demonstrator, which lies at (0,0).

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{polarAnglesTop.png}}%
\end{figure}

\textbf{\emph{Calculated polar angles for topology}:} \\
This plot describes the slant depth in an area around the Majorana demonstrator in polar angles theta and phi.

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{polarAnglesTop2.png}}%
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{axisProjections.png}}%
\end{figure}

\textbf{\emph{Polar angles Projections \& Slant Depth Projections}:} \\
X and Y axis projections for the slant depth and polar angles plots.

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{Topology.png}}%
\end{figure}

\textbf{\emph{Landscape2}:} \\
The topology chart used to calculate each angle.

\pagebreak
\textbf{Uncertainty estimate:} \\

$$\Delta\theta=\tan^{-1}{(\frac{\sqrt{(\frac{30.8}{2})^{2}+(\frac{23.3}{2})^{2}}}{1478})}=\textbf{0.75\degree}$$

\begin{figure}[H]
\makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{errorCalc.pdf}}%
\end{figure}
